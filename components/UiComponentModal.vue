            ...
            <div class="form-group">
              ...
              <div class="code-editor">
                ...
                <textarea
                  ...
                  v-model="form.code"
                  rows="20"
                  placeholder="Вставьте полный код компонента (HTML + CSS + JS)..."
                  class="code-textarea"
                ></textarea>
                ...
                <textarea
                  ...
                  v-model="htmlCode"
                  rows="15"
                  placeholder="HTML код будет извлечен автоматически..."
                  class="code-textarea"
                  readonly
                ></textarea>
                ...
                <textarea
                  ...
                  v-model="cssCode"
                  rows="15"
                  placeholder="CSS код будет извлечен автоматически..."
                  class="code-textarea"
                  readonly
                ></textarea>
                ...
                <textarea
                  ...
                  v-model="jsCode"
                  rows="15"
                  placeholder="JavaScript код будет извлечен автоматически..."
                  class="code-textarea"
                  readonly
                ></textarea>
              </div>
...
// Извлечение частей кода для отображения
...
const cssCode = computed(() => {
  ...
  const styleMatch = form.value.code.match(/<style[^>]*>([\s\S]*?)<\/style>/i);
...
const jsCode = computed(() => {
  ...
  const scriptMatch = form.value.code.match(
    /<script[^>]*>([\s\S]*?)<\/script>/i
  );
